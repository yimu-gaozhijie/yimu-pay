...
import com.me.yimu.pay.user.api.dto.tenant.*;
import com.me.yimu.pay.user.convert.*;
import com.me.yimu.pay.user.entity.*;
import com.me.yimu.pay.user.mapper.*;
import com.me.yimu.pay.utils.MD5Util;
import com.me.yimu.pay.utils.PhoneUtil;
import com.me.yimu.pay.utils.RandomStringUtil;
...
//////////////////////////////////////////租户相关的操作///////////////////////////////////////////////////
    ...
    public LoginInfoDTO login(LoginRequestDTO loginRequest) {
        log.info("login(LoginRequestDTO loginRequest) : start");
